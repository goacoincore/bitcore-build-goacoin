...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-goacoin/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-goacoin -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-goacoin -o bitcore-lib-goacoin.js';
    }
